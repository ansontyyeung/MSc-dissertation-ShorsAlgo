...
# A function to fix cannot show plots when generated inside of loops
...
# Specify variables
#N_COUNT = 2*4+3-4  # number of counting qubits, 2n+3 qubits needed
N_COUNT = 7
a = 2
...
#qc.decompose().draw(fold=-1)  # -1 means 'do not fold'
qc.draw(fold=-1)
...
key = f"error=0"
fac15_noise_free_counts[key] = sorted_noise_free_counts
...
ax.grid(False)
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_brisbane.png"
...
fac15_noise_free_success_comparison_df=analyze_simulation_results_noise(fac15_noise_free_counts)


# In[13]:


fac15_noise_free_counts={}
...
ax.grid(False)
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_noise-free.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
fac15_noise_free_success_comparison_df=analyze_simulation_results_noise(fac15_noise_free_counts)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_noise-free_data.txt'
#store_file(file_path, fac15_noise_free_counts)


# In[13]:


all_fac15_noise_free_counts = {}
...
for i, shots in enumerate(shot_values):
    ...
    # Store the results
    key = f"Shots={shots}"
    all_fac15_noise_free_counts[key] = sorted_counts_shots
    
    print("Time taken for {} shots: {} sec".format(key, result_shots.time_taken))

plt.suptitle("Factor 15: Noise-free Simulation Results with Varying Shot Values")
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_noise-free_vary_shots.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
fac15_noise_free_shots_success_comparison_df = analyze_simulation_results_noise(all_fac15_noise_free_counts)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_noise-free_vary_shots_data.txt'
store_file(file_path, all_fac15_noise_free_counts)
...
plt.plot(fac15_noise_free_shots_success_comparison_df['Key'], fac15_noise_free_shots_success_comparison_df['Correct percentage'],marker='o', markersize=5)
plt.xlabel('Shots')
plt.ylabel('Success Rate')
plt.title('Factor 15 Success Rate with Varying Shots under Noise-Free Condition')
#plt.gca().invert_yaxis()
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.0f%%'))

plt.grid(True)
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_noise-free_vary_shots_success_rate.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
meas_calibs, state_labels = qiskit.utils.mitigation.circuits.complete_meas_cal(qubit_list=[0,1,2,3], qr=qr)

# Step through the values of qubitk_p0_given1 and qubitk_p1_given0
start = 1e-3
end = 4.93e-1
num_steps = 6
all_fac15_ro_noise_counts = {}
...
for i in range(num_steps):
    ...
    all_fac15_ro_noise_counts[key] = sorted_counts_readout
    
    print("Time taken to run readout error={}: {} sec".format(key,result_readout.time_taken))
    
plt.suptitle("Factor 15: Readout Noise Simulation Results with Varying Shot Values")
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_readout.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
fac15_ro_noise_success_comparison_df=analyze_simulation_results_noise(all_fac15_ro_noise_counts)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_readout_data.txt'
store_file(file_path, all_fac15_ro_noise_counts)
...
plt.figure(figsize=(6, 4.5))
plt.plot(list(range(len(fac15_ro_noise_success_comparison_df['Key']))), fac15_ro_noise_success_comparison_df['Correct percentage'],marker='o', markersize=5, label='shots=1024')
plt.xticks(list(range(len(fac15_ro_noise_success_comparison_df['Key']))), fac15_ro_noise_success_comparison_df['Key'])
# plt.plot(fac15_ro_noise_success_comparison_df['Key'], fac15_ro_noise_success_comparison_df['Correct percentage'],marker='o', markersize=5)
plt.xlabel('Readout Error')
plt.ylabel('Success Rate')
plt.title('Factor 15 Success Rate with Readout Error')
#plt.gca().invert_yaxis()
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.0f%%'))
plt.grid(True)
plt.legend()
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_readout_success_rate.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
num_steps = 6
all_fac15_depolar_noise_counts = {}
figures = []  # Create a list to store the figures
fig, axes = plt.subplots(2, 3, figsize=(20, 13))
axes = axes.flatten()
...
for i in range(num_steps):
    ...
    all_fac15_depolar_noise_counts[key] = sorted_counts_depolar
    
    print("Time taken to run depolarising error={}: {} sec".format(key,result_depolar.time_taken)) 
    
plt.suptitle("Factor 15: Depolarising Error Simulation Results")
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_depolarising_small.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
fac15_dp_noise_success_comparison_df=analyze_simulation_results_noise(all_fac15_depolar_noise_counts)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_depolarising_data_small.txt'
store_file(file_path, all_fac15_depolar_noise_counts)
...
plt.figure(figsize=(6, 4.5))
plt.plot(fac15_dp_noise_success_comparison_df['Key'], fac15_dp_noise_success_comparison_df['Correct percentage'],marker='o', markersize=5, label='shots=1024')
plt.xlabel('Depolarising Error')
plt.ylabel('Success Rate')
plt.title('Factor 15 Success Rate with Depolarising Error')
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.0f%%'))
plt.grid(True)
plt.legend()
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_depolarising_success_rate_small.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
# h_gate = SwapGate()
# print(f"Duration of H gate: {h_gate.duration} time units")
...
time_measure = 70
num_steps = 6
all_fac15_thermal_noise_counts = {}
figures = []  # Create a list to store the figures
fig, axes = plt.subplots(2, 3, figsize=(20, 13))
axes = axes.flatten()
...
#     print("error two qubit rate is: {}".format(errors_two_qubit.to_dict()))
    ...
    # Store the results
    key = f"T1={T1};T2={T2}"
    all_fac15_thermal_noise_counts[key] = sorted_counts_thermal
    
    print("Time taken to run thermal relaxation error={}: {} sec".format(key,result_thermal.time_taken)) 
    
plt.suptitle("Factor 15: Thermal Relaxation Error Simulation Results")
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_thermal.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
fac15_thermal_noise_success_comparison_df=analyze_simulation_results_noise(all_fac15_thermal_noise_counts, is_thermal=True)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_thermal_data.txt'
store_file(file_path, all_fac15_thermal_noise_counts, is_thermal=True)
...
plt.plot(fac15_thermal_noise_success_comparison_df['Key_T1'], fac15_thermal_noise_success_comparison_df['Correct percentage'],marker='o', markersize=5, label='shots=1024')
plt.xlabel('Thermal Relaxation Error')
plt.ylabel('Success Rate')
plt.title('Factor 15 Success Rate with Thermal Relaxation Error')
x_labels = ["T1={}us\nT2={}us".format(t1,t2) for t1, t2 in zip(fac15_thermal_noise_success_comparison_df['Key_T1'], fac15_thermal_noise_success_comparison_df['Key_T2'])]
plt.xticks(fac15_thermal_noise_success_comparison_df['Key_T1'], x_labels)
plt.gca().yaxis.set_major_formatter(FormatStrFormatter('%.0f%%'))
plt.grid(True)
plt.legend()
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_thermal_success_rate.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
fac15_ro_noise_counts[key] = sorted_counts_readout

# Depolarising Median Sim
noise_depolar = NoiseModel()
fac15_depolar_noise_counts = {}
...
fac15_depolar_noise_counts[key] = sorted_counts_depolar

# Thermal Relaxation Median Sim
noise_thermal = NoiseModel()
fac15_thermal_noise_counts = {}
time_one_qubit = 70
time_two_qubit = 559
time_measure = 70
...
key = f"T1={median_T1};T2={median_T1}"
fac15_thermal_noise_counts[key] = sorted_counts_thermal

plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_median_rerun.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
fac15_noise_free_success_comparison_df = analyze_simulation_results_noise(fac15_noise_free_counts)
fac15_median_readout_noise_success_comparison_df = analyze_simulation_results_noise(fac15_ro_noise_counts)
fac15_median_depolar_noise_success_comparison_df = analyze_simulation_results_noise(fac15_depolar_noise_counts)
fac15_median_thermal_noise_success_comparison_df = analyze_simulation_results_noise(fac15_thermal_noise_counts, is_thermal=True)

file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_median_data_free.txt'
store_file(file_path, fac15_noise_free_counts)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_median_data_readout.txt'
store_file(file_path, fac15_ro_noise_counts)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_median_data_depolarising.txt'
store_file(file_path, fac15_depolar_noise_counts)
file_path = r'C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Data\fac15_median_data_thermal.txt'
store_file(file_path, fac15_thermal_noise_counts, is_thermal=True)


# In[146]:


df = pd.concat([fac15_noise_free_success_comparison_df,
                fac15_median_readout_noise_success_comparison_df,
                fac15_median_depolar_noise_success_comparison_df,
                fac15_median_thermal_noise_success_comparison_df])

# Create the plot
plt.figure(figsize=(6, 4.5))
df.plot(kind='bar', legend=False,  rot=0)
plt.legend(['shots=1024'], loc='upper right', bbox_to_anchor=(1, 0.9))
...
plt.tight_layout()
save_path = r"C:\Users\User\OneDrive\Desktop\2024MScDissertation\SimResults\Plot\fac15_median_success_rate_rerun.png"
os.makedirs(os.path.dirname(save_path), exist_ok=True)
plt.savefig(save_path)
plt.show()
...
plot_histogram([counts, counts_depolar, counts_thermal, counts_readout],
              title='Counts for different error models',
              legend=['no noise', 'depolarisation error','thermal relaxation error', 'readout error'])